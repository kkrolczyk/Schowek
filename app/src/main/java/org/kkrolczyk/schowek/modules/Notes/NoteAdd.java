...
import org.kkrolczyk.schowek.externals.AesCbcWithIntegrity;
            ...
            alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    try {
                        ...
                        keys = AesCbcWithIntegrity.generateKeyFromPassword(input.getText().toString(), "AesDontNeedSalt?");
                        AesCbcWithIntegrity.CipherTextIvMac encoded = new AesCbcWithIntegrity.CipherTextIvMac(real_message);
                        real_message = AesCbcWithIntegrity.decryptString(encoded, keys);
    ...
    public void save_encrypted_note(View v) {
        ...
        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                try {
                    keys = AesCbcWithIntegrity.generateKeyFromPassword(input.getText().toString(), "AesDontNeedSalt?");
                    String secure = AesCbcWithIntegrity.encrypt(textField.getText().toString(), keys).toString();
                    String title;
